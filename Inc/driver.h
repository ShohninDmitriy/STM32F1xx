...
#if TRINAMIC_ENABLE && !(defined(BOARD_CNC_BOOSTERPACK) || defined(BTT_SKR_MINI_11) || defined(BTT_SKR_MINI_E3_V20) || defined(BTT_SKR_MINI_E3_V20_ALT2) || defined(TRINAMIC_DEBUG))
